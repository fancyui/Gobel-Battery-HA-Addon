...
class HA_MQTT_JK:
    ...
    def _publish_pack_settings(self, settings, pack_num):
        ...
        setup_mappings = {
            ...
            'vol_inverter_max_charge': ('inverter_max_charge_voltage', 'V', 'mdi:battery-charging', 'voltage', 'measurement'),
            'vol_float_charge':        ('float_charge_voltage', 'V', 'mdi:battery-charging-100', 'voltage', 'measurement'),
