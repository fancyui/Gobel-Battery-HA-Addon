...
-   [Addon] Add multilingual translation support (English and Chinese) for configuration options to display user-friendly names and descriptions in the Home Assistant Add-on settings page.
